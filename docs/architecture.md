...
| Studio persistence | `src/studio/StudioProjectStore.ts`, `persistence/` | Validated publication, generation history, recovery, and independent support-file reconciliation. |
