...
| Studio persistence | `src/studio/StudioProjectStore.ts`, `document/`, `persistence/` | One collaborative `.systemsculpt` document per project: validated import, scoped UI and agent edits, atomic publication, and independent support-file reconciliation. |
