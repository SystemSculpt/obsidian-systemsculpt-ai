...
Refined by [ADR-0003](0003-single-file-studio-documents.md): the recovery snapshot store described below was replaced by merge state embedded in the single project document.
