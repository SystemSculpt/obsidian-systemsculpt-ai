...
export type SimilaritySearchSource =
  ...
  | Readonly<{ kind: "chat"; key: string; chatView: AgentChatView }>;
...
export class SimilaritySearchRunCoordinator {
  ...
  public async run(source: SimilaritySearchSource): Promise<void> {
    ...
    const AbortControllerCtor = (this.ownerWindow() as Window & {
  ...
  private ownerWindow(): Window {
    return this.options.getOwnerWindow();
  }
}
...
export function chatSimilaritySource(chatView: AgentChatView): SimilaritySearchSource {
