...
export const CHAT_ATTACHMENT_UNAVAILABLE_SENTINEL = "[[SYSTEMSCULPT_ATTACHMENT_UNAVAILABLE]]";
...
export function createAttachedTextContent(name: string, mimeType: string, body: string): string {
  return [
