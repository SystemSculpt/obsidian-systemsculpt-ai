...
/**
 * Tool-usage instructions extracted from the agent system prompt.
 * These are the "mechanical" sections about how to use tools.
 * Compose with custom user prompts when agent mode is ON so tools still work.
 */
export const AGENT_TOOL_INSTRUCTIONS = `<search_strategy>
