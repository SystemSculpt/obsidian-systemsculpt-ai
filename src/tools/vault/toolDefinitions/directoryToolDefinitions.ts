...
export const directoryToolDefinitions: FirstPartyToolDefinition[] = [
  {
    name: "create_folders",
    ...
    inputSchema: {
      ...
      properties: {
        ...
        offset: {
          ...
          minimum: 0,
          default: 0,
          description: "Stable zero-based item offset for each requested directory"
        },
        limit: {
          type: "number",
          minimum: 1,
          maximum: 50,
          default: 25,
          description: "Maximum items returned per requested directory"
        }
      },
      required: ["paths"],
      additionalProperties: false
