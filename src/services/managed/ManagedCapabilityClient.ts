...
export class ManagedCapabilityClient {
  ...
  public streamAcceptedChat(
    ...
    if (
      ...
      lease.descriptor.mode !== "stream" || lease.descriptor.endpoint !== "/api/plugin/chat/completions" ||
      ...
      lease.requestContract.request?.path !== "/api/plugin/chat/completions" || lease.requestContract.request.method !== "POST"
    ) {
