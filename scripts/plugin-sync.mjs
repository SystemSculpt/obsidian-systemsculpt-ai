...
export function loadConfiguredTargets(options = {}) {
  ...
  const targets = [
    ...pluginTargets.map((entry) => normalizeConfigTarget(entry, { group: "pluginTargets", root })),
    ...mirrorTargets.map((entry) => normalizeConfigTarget(entry, { group: "mirrorTargets", root })),
